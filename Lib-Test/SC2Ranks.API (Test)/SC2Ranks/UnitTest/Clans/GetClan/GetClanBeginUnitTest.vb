...
Namespace SC2Ranks.UnitTest.Clans.GetClan
  Public Class GetClanBeginUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      Else
        Call Me.Service.GetClanBegin(Nothing, [Const].RankRegion, [Const].ClanTag, EndCallback)
      End If
    End Sub
    ...
    Public Sub [End](Optional Result As IAsyncResult = Nothing) Implements IUnitTestCase.[End]
      ...
      Me.Ex = Me.Service.GetClanEnd(Result, Nothing, Response)

      If (Ex Is Nothing) Then
        If Response.HasError Then
          Me.Ex = New Exception(Response.Error)
        Else
          Me.m_Result = Helper.CheckResult(Of Sc2RanksGetClanResult)("GetClanBegin", Me.Ex, Response)
        End If
      End If
    End Sub
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: GetClanBegin"
      End Get
    End Property
