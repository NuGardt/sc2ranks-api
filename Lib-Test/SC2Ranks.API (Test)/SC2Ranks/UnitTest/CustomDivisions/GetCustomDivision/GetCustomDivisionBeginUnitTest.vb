...
Namespace SC2Ranks.UnitTest.CustomDivisions.GetCustomDivision
  Public Class GetCustomDivisionBeginUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      Else
        Call Me.Service.GetCustomDivisionBegin(Nothing, [Const].CustomDivisionID, EndCallback)
      End If
    End Sub
    ...
    Public Sub [End](Optional Result As IAsyncResult = Nothing) Implements IUnitTestCase.[End]
      Dim Response As Sc2RanksGetCustomDivisionResult = Nothing

      Me.Ex = Me.Service.GetCustomDivisionEnd(Result, Nothing, Response)

      If (Ex Is Nothing) Then
        If Response.HasError Then
          Me.Ex = New Exception(Response.Error)
        Else
          Me.m_Result = Helper(Of Sc2RanksGetCustomDivisionResult).CheckResult("GetCustomDivisionBegin", Me.Ex, Response)
        End If
      End If
    End Sub
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: GetCustomDivisionBegin"
      End Get
    End Property
