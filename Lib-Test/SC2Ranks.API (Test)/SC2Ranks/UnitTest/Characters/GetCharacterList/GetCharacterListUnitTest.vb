...
Namespace SC2Ranks.UnitTest.Characters.GetCharacterList
  Public Class GetCharacterListUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      If (Me.Ex Is Nothing) Then
        ...
        If (Ex Is Nothing) Then
          ...
          Else
            Me.m_Result = Helper(Of Sc2RanksGetCharacterListResult).CheckResult("GetCharacterList", Me.Ex, Response)
          End If
        End If
      End If
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: GetCharacterList"
      End Get
    End Property
