...
Namespace SC2Ranks.API.Result.Element
  <DataContract()>
  Public Class Sc2RanksClanExtended
    Inherits Sc2RanksClanBasic
    '{
    ...
    Private m_Scores As Sc2RanksScores
...
#Region "Properties"
    ...
    Public Property Scores As Sc2RanksScores
      Get
        Return Me.m_Scores
      End Get
      Private Set(ByVal Value As Sc2RanksScores)
        Me.m_Scores = Value
      End Set
    End Property
