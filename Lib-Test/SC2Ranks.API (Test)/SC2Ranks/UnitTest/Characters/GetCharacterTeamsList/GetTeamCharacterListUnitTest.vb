...
Namespace SC2Ranks.UnitTest.Characters.GetCharacterTeamsList
  Public Class GetCharacterTeamsListUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      If (Me.Ex Is Nothing) Then
        ...
        Me.Ex = Me.Service.GetCharacterTeamsList([Const].Region, [Const].BattleNetID, [Const].Expansion, [Const].Bracket, [Const].League, Response)

        If (Ex Is Nothing) Then
          If Response.HasError Then
            Me.Ex = New Exception(Response.Error)
          Else
            Me.m_Result = Helper.CheckResult(Of Sc2RanksGetCharacterTeamsListResult)("GetCharacterTeamsList", Me.Ex, Response)
          End If
        End If
      End If
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: GetCharacterTeamsList"
      End Get
    End Property
