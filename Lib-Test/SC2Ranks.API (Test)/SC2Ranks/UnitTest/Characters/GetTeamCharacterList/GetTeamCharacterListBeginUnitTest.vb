...
Namespace SC2Ranks.UnitTest.Characters.GetTeamCharacterList
  Public Class GetTeamCharacterListBeginUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      Else
        Call Me.Service.GetTeamCharacterListBegin(Nothing, [Const].Region, [Const].BattleNetID, [Const].Expansion, [Const].Bracket, [Const].League, EndCallback)
      End If
    End Sub
    ...
    Public Sub [End](Optional Result As IAsyncResult = Nothing) Implements IUnitTestCase.[End]
      ...
      Me.Ex = Me.Service.GetTeamCharacterListEnd(Result, Nothing, Response)

      If (Ex Is Nothing) Then
        If Response.HasError Then
          Me.Ex = New Exception(Response.Error)
        Else
          Me.m_Result = Helper.CheckResult(Of Sc2RanksTeamCharacterListResult)("GetTeamCharacterListBegin", Me.Ex, Response)
        End If
      End If
    End Sub
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: GetTeamCharacterListBegin"
      End Get
    End Property
