...
Namespace SC2Ranks.UnitTest.Characters.SearchCharacterTeamList
  Public Class SearchCharacterTeamListUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      If (Me.Ex Is Nothing) Then
        Dim Response As Sc2RanksSearchCharacterTeamListResult = Nothing
        ...
        If (Ex Is Nothing) Then
          ...
          Else
            Me.m_Result = Helper(Of Sc2RanksSearchCharacterTeamListResult).CheckResult("SearchCharacterTeams", Me.Ex, Response)
          End If
        End If
      End If
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: SearchCharacterTeams"
      End Get
    End Property
