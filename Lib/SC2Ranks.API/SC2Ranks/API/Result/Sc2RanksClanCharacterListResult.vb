...
Namespace SC2Ranks.API.Result
  <DataContract()>
  Public Class Sc2RanksClanCharacterListResult
    Inherits Sc2RanksClanResult
    '{
    ...
    Private m_Pagination As Sc2RanksPaginationElement
...
#Region "Properties"
    ...
    Public Property Characters As Sc2RanksCharacterResult()
      Get
        Return Me.m_Characters
      End Get
      Private Set(ByVal Value As Sc2RanksCharacterResult())
        Me.m_Characters = Value
      End Set
    End Property

    <DataMember(Name := "pagination")>
    Public Property Pagination As Sc2RanksPaginationElement
      Get
        Return Me.m_Pagination
      End Get
      Private Set(ByVal Value As Sc2RanksPaginationElement)
