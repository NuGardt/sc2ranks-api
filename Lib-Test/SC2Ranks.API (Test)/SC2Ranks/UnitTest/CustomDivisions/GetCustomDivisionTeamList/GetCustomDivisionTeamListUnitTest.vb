...
Namespace SC2Ranks.UnitTest.CustomDivisions.GetCustomDivisionTeamList
  Public Class GetCustomDivisionTeamListUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      If (Me.Ex Is Nothing) Then
        ...
        If (Ex Is Nothing) Then
          ...
          Else
            Me.m_Result = Helper.CheckResult(Of Sc2RanksGetCustomDivisionTeamListResult)("GetCustomDivisionTeams", Me.Ex, Response)
          End If
        End If
      End If
