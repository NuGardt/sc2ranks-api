...
Namespace SC2Ranks.API.Result.Element
  <DataContract()>
  Public Class Sc2RanksExpansionsElement
    '"expansions": {
    '  "hots": {
    ...
    Private m_Wol As Sc2RanksNotationElement
    Private m_Hots As Sc2RanksNotationElement
    ...
    <DataMember(name := "wol")>
    Public Property Wol As Sc2RanksNotationElement
      Get
        Return Me.m_Wol
      End Get
    ...
    Public Property Hots As Sc2RanksNotationElement
      Get
        Return Me.m_Hots
      End Get
      Private Set(ByVal Value As Sc2RanksNotationElement)
