...
Namespace SC2Ranks.API.Result.Element
  <DataContract()>
  Public Class Sc2RanksRegionsElement
    '"regions": {
    '  "global": {
    '    "long": "Global",
    '    "short": "Global"
    ...
    Private m_Us As Sc2RanksNotationElement
    Private m_Tw As Sc2RanksNotationElement
    Private m_Kr As Sc2RanksNotationElement
    Private m_La As Sc2RanksNotationElement
    Private m_Ru As Sc2RanksNotationElement
    ...
    <DataMember(name := "us")>
    Public Property Us As Sc2RanksNotationElement
      Get
        Return Me.m_Us
      End Get
      Private Set(ByVal Value As Sc2RanksNotationElement)
    ...
    <DataMember(name := "tw")>
    Public Property Tw As Sc2RanksNotationElement
      Get
        Return Me.m_Tw
      End Get
      Private Set(ByVal Value As Sc2RanksNotationElement)
    ...
    <DataMember(name := "kr")>
    Public Property Kr As Sc2RanksNotationElement
      Get
        Return Me.m_Kr
      End Get
      Private Set(ByVal Value As Sc2RanksNotationElement)
    ...
    <DataMember(name := "la")>
    Public Property La As Sc2RanksNotationElement
      Get
        Return Me.m_La
      End Get
      Private Set(ByVal Value As Sc2RanksNotationElement)
    ...
    <DataMember(name := "ru")>
    Public Property Ru As Sc2RanksNotationElement
      Get
        Return Me.m_Ru
      End Get
      Private Set(ByVal Value As Sc2RanksNotationElement)
