...
Namespace SC2Ranks.UnitTest.Divisions.GetDivisionsTop
  Public Class GetDivisionsTopBeginUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      Else
        Call Me.Service.GetDivisionsTopBegin(Nothing, [Const].RankRegion, [Const].Expansion, [Const].Bracket, [Const].League, EndCallback, 5)
      End If
    End Sub
    ...
    Public Sub [End](Optional Result As IAsyncResult = Nothing) Implements IUnitTestCase.[End]
      ...
      If (Ex Is Nothing) Then
        ...
        Else
          Me.m_Result = Helper(Of Sc2RanksGetDivisionsTopResult).CheckResult("GetDivisionsTopBegin", Me.Ex, Response)
        End If
      End If
    End Sub
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: GetDivisionsTopBegin"
      End Get
    End Property
