...
Namespace SC2Ranks.API.Result.Element
  ...
  Public Class Sc2RanksCustomDivisionManagementStatusList
    ...
    Public Sub CopyTo(ByVal Array() As Sc2RanksCustomDivisionManagementStatus,
                      ByVal ArrayIndex As Integer) Implements ICollection(Of Sc2RanksCustomDivisionManagementStatus).CopyTo
      Call Me.m_List.CopyTo(Array, ArrayIndex)
    End Sub

    Public ReadOnly Property Count As Integer Implements ICollection(Of Sc2RanksCustomDivisionManagementStatus).Count
      Get
    ...
    Public Function IndexOf(ByVal Item As Sc2RanksCustomDivisionManagementStatus) As Integer Implements IList(Of Sc2RanksCustomDivisionManagementStatus).IndexOf
    ...
    Default Public Property Item(ByVal Index As Integer) As Sc2RanksCustomDivisionManagementStatus Implements IList(Of Sc2RanksCustomDivisionManagementStatus).Item
      Get
    ...
    Public Sub RemoveAt(ByVal Index As Integer) Implements IList(Of Sc2RanksCustomDivisionManagementStatus).RemoveAt
