...
Namespace SC2Ranks.UnitTest.Divisions.GetDivisionTeamList
  Public Class GetDivisionTeamListBeginUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      Else
        Call Me.Service.GetDivisionTeamListBegin(Nothing, [Const].DivisionID, EndCallback)
      End If
    End Sub
    ...
    Public Sub [End](Optional Result As IAsyncResult = Nothing) Implements IUnitTestCase.[End]
      Dim Response As Sc2RanksDivisionTeamsListResult = Nothing

      Me.Ex = Me.Service.GetDivisionTeamListEnd(Result, Nothing, Response)

      If (Ex Is Nothing) Then
        If Response.HasError Then
          Me.Ex = New Exception(Response.Error)
        Else
          Me.m_Result = Helper.CheckResult(Of Sc2RanksDivisionResult)("GetDivisionTeamListBegin", Me.Ex, Response)
        End If
      End If
    End Sub
