...
Namespace SC2Ranks.UnitTest.CustomDivisions.GetCustomDivisions
  Public Class GetCustomDivisionsUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      If (Me.Ex Is Nothing) Then
        ...
        If (Ex Is Nothing) Then
          ...
          Else
            Me.m_Result = Helper(Of Sc2RanksGetCustomDivisionsResult).CheckResult("GetCustomDivisions", Me.Ex, Response)
          End If
        End If
      End If
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: GetCustomDivisions"
      End Get
    End Property
