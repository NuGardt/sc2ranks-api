...
Namespace SC2Ranks.UnitTest.Clans.GetClanTeamList
  Public Class GetClanTeamListUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      If (Me.Ex Is Nothing) Then
        ...
        Me.Ex = Me.Service.GetClanTeamList([Const].RankRegion, [Const].ClanTag, [Const].Expansion, [Const].Bracket, [Const].League, Response)

        If (Ex Is Nothing) Then
          If Response.HasError Then
            Me.Ex = New Exception(Response.Error)
          Else
            Me.m_Result = Helper.CheckResult(Of Sc2RanksGetClanTeamListResult)("GetClanTeamList", Me.Ex, Response)
          End If
        End If
      End If
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: GetClanTeamList"
      End Get
    End Property
