...
Namespace SC2Ranks.UnitTest.Divisions.GetDivision
  Public Class GetDivisionUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      If (Me.Ex Is Nothing) Then
        Dim Response As Sc2RanksDivisionResult = Nothing
        ...
        If (Ex Is Nothing) Then
          ...
          Else
            Me.m_Result = Helper.CheckResult(Of Sc2RanksDivisionResult)("GetDivision", Me.Ex, Response)
          End If
        End If
      End If
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: GetDivision"
      End Get
    End Property
