...
Namespace SC2Ranks.UnitTest.CustomDivisions.CustomDivisionAdd
  Public Class CustomDivisionAddUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      If (Me.Ex Is Nothing) Then
        ...
        Me.Ex = Me.Service.CustomDivisionAdd([Const].ManageCustomDivisionID, Characters, Response)
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: CustomDivisionAdd"
      End Get
    End Property
