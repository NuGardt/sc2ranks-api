...
Namespace SC2Ranks.UnitTest.CustomDivisions.GetCustomDivisionCharacterList
  Public Class GetCustomDivisionCharacterListBeginUnitTest
    ...
    Public Sub [End](Optional Result As IAsyncResult = Nothing) Implements IUnitTestCase.[End]
      Dim Response As Sc2RanksGetCustomDivisionCharacterListResult = Nothing
      ...
      If (Ex Is Nothing) Then
        ...
        Else
          Me.m_Result = Helper(Of Sc2RanksGetCustomDivisionCharacterListResult).CheckResult("GetCustomDivisionCharactersBegin", Me.Ex, Response)
        End If
      End If
    End Sub
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: GetCustomDivisionCharactersBegin"
      End Get
    End Property
