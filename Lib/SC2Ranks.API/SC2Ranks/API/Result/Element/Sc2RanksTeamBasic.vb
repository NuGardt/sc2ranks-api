...
Namespace SC2Ranks.API.Result.Element
  <DataContract()>
  Public Class Sc2RanksTeamBasic
    '{
    ...
    Private m_Division As Sc2RanksTeamDivision
    Private m_Rankings As Sc2RanksRankings
    ...
    Public Property Division As Sc2RanksTeamDivision
      Get
        Return Me.m_Division
      End Get
      Private Set(ByVal Value As Sc2RanksTeamDivision)
        Me.m_Division = Value
      End Set
    End Property

    <DataMember(name := "rankings")>
    Public Property Rankings As Sc2RanksRankings
      Get
        Return Me.m_Rankings
      End Get
      Private Set(ByVal Value As Sc2RanksRankings)
        Me.m_Rankings = Value
      End Set
    End Property
