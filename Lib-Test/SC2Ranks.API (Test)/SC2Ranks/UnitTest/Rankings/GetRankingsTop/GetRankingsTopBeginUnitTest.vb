...
Namespace SC2Ranks.UnitTest.Rankings.GetRankingsTop
  Public Class GetRankingsTopBeginUnitTest
    ...
    Public Sub [End](Optional Result As IAsyncResult = Nothing) Implements IUnitTestCase.[End]
      ...
      If (Ex Is Nothing) Then
        ...
        Else
          Me.m_Result = Helper(Of Sc2RanksGetRankingsTopResult).CheckResult("GetRankingsTopBegin", Me.Ex, Response)
        End If
      End If
    End Sub
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: GetRankingsTopBegin"
      End Get
    End Property
