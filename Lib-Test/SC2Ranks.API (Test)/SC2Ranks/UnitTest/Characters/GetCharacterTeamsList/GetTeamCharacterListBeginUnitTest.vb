...
Namespace SC2Ranks.UnitTest.Characters.GetCharacterTeamsList
  Public Class GetCharacterTeamsListBeginUnitTest
    ...
    Public Sub Start(ByVal OnCompletion As AsyncCallback,
      ...
      Else
        Call Me.Service.GetCharacterTeamsListBegin(Nothing, [Const].Region, [Const].BattleNetID, [Const].Expansion, [Const].Bracket, [Const].League, EndCallback)
      End If
    End Sub
    ...
    Public Sub [End](Optional Result As IAsyncResult = Nothing) Implements IUnitTestCase.[End]
      Dim Response As Sc2RanksGetCharacterTeamsListResult = Nothing

      Me.Ex = Me.Service.GetCharacterTeamsListEnd(Result, Nothing, Response)

      If (Ex Is Nothing) Then
        If Response.HasError Then
          Me.Ex = New Exception(Response.Error)
        Else
          Me.m_Result = Helper(Of Sc2RanksGetCharacterTeamsListResult).CheckResult("GetCharacterTeamsListBegin", Me.Ex, Response)
        End If
      End If
    End Sub
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: GetCharacterTeamsListBegin"
      End Get
    End Property
