...
Namespace SC2Ranks.UnitTest.CustomDivisions.GetCustomDivisionTeamList
  Public Class GetCustomDivisionTeamListBeginUnitTest
    ...
    Public Sub [End](Optional Result As IAsyncResult = Nothing) Implements IUnitTestCase.[End]
      Dim Response As Sc2RanksGetCustomDivisionTeamListResult = Nothing
      ...
      If (Ex Is Nothing) Then
        ...
        Else
          Me.m_Result = Helper(Of Sc2RanksGetCustomDivisionTeamListResult).CheckResult("GetCustomDivisionTeamsBegin", Me.Ex, Response)
        End If
      End If
    End Sub
