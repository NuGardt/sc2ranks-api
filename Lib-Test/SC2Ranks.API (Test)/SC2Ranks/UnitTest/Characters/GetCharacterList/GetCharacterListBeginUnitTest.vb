...
Namespace SC2Ranks.UnitTest.Characters.GetCharacterList
  Public Class GetCharacterListBeginUnitTest
    ...
    Public Sub [End](Optional Result As IAsyncResult = Nothing) Implements IUnitTestCase.[End]
      Dim Response As Sc2RanksGetCharacterListResult = Nothing
      ...
      If (Ex Is Nothing) Then
        ...
        Else
          Me.m_Result = Helper(Of Sc2RanksGetCharacterListResult).CheckResult("GetCharacterListBegin", Me.Ex, Response)
        End If
      End If
    End Sub
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: GetCharacterListBegin"
      End Get
    End Property
