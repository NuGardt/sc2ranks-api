...
Namespace SC2Ranks.UnitTest.BaseData.GetBaseData
  Public Class GetBaseDataBeginUnitTest
    ...
    Public Sub [End](Optional Result As IAsyncResult = Nothing) Implements IUnitTestCase.[End]
      Dim Response As Sc2RanksGetBaseDataResult = Nothing
      ...
      If (Ex Is Nothing) Then
        ...
        Else
          Me.m_Result = Helper(Of Sc2RanksGetBaseDataResult).CheckResult("GetDataBegin", Me.Ex, Response)
        End If
      End If
    End Sub
    ...
    Public ReadOnly Property Name As String Implements IUnitTestCase.Name
      Get
        Return "SC2Ranks API: GetDataBegin"
      End Get
    End Property
